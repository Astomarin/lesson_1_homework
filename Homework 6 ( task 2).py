...
unique_keys_1 = list(set(my_dict_1.keys()) - set(my_dict_2.keys()))
new_dict = {key: my_dict_1[key] for key in unique_keys_1 if key not in my_dict_2}
merged_dict = {}
...
print("б) Список ключей, які є в першому але немає в другому", unique_keys_1)
